...
const navItems = [
  ...
  { name: "Mango Special", href: "/mango-special" },
...
const dropdownItems = [
  ...
  { name: "Cakes for Dog Lovers", href: "/cakes-for-dog-lovers" },
  { name: "Car Cakes", href: "/car-cakes" },
  { name: "Cakes for HIM", href: "/cakes-for-him" },
  { name: "Football Cakes", href: "/football-cakes" },
  { name: "Half Year Birthday Cakes", href: "/half-year-birthday-cakes" },
  { name: "Peppa Pig Cakes", href: "/peppa-pig-cakes" },
  { name: "Travel Theme Cakes", href: "/travel-theme-cakes" },
  ...
  { name: "Cocomelon Theme Cakes", href: "/cocomelon-theme-cakes" },
